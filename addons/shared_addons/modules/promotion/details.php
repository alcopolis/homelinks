...
class Module_Promotion extends Module {
	...
	{
		$this->dbforge->drop_table('promotion_category');
		...
		if($this->dbforge->create_table('promotion'))
		{
			$this->dbforge->add_field($promo_cat);
			$this->dbforge->add_key('id', TRUE);
			
			if($this->dbforge->create_table('promotion_category'))
			{
				return TRUE;
			}
		}else{
	...
	{
		if($this->dbforge->drop_table('promotion') && $this->dbforge->drop_table('promotion_category')){
			return TRUE;
		}else{
			return FALSE;
		}
